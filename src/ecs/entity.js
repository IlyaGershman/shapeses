...
export class Entity {
  ...
  RegisterGlobalHandler(n, h) {
    this.parent_.RegisterGlobalHandler(n, h);
  }
  ...
  GlobalBroadcast(msg) {
    this.parent_.GlobalBroadcast(msg);
  }
...
export class Component {
  ...
  Broadcast(m) {
    console.log({ [`Broadcast:${m.topic}`]: m });
    this.parent_.Broadcast(m);
  }

  GlobalBroadcast(m) {
    console.log({ [`GlobalBroadcast:${m.topic}`]: m });
    this.parent_.GlobalBroadcast(m);
  }

  Update(_) {}

  RegisterHandler(n, h) {
    this.parent_.RegisterHandler(n, h);
  }
